...
//set server values
		...
		if (isset($data->TrackID)) { $Tracks->TrackID         = $data->TrackID; };
                if (isset($data->Requester)) { $Tracks->Requester         = $data->Requester; };
                if (isset($data->Greeting)) { $Tracks->Greeting         = $data->Greeting; };
                if (isset($data->StationID)) { $Tracks->StationID         = $data->StationID; };
                if (isset($data->Source)) { $Tracks->Source         = $data->Source; };

//Create server

$rc = $Tracks->addrequest();
